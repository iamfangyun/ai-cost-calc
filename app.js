...
const AI_SUBS = [
  ...
  { name: "Claude Code Max 5x", price: 100, cat: "Coding" },
  { name: "Claude Code Max 20x", price: 200, cat: "Coding" },
  { name: "GitHub Copilot", price: 10, cat: "Coding" },
  { name: "Windsurf Pro", price: 15, cat: "Coding" },
  { name: "ChatGPT Plus (coding)", price: 20, cat: "Coding" },
  { name: "Midjourney Basic", price: 10, cat: "Image" },
  { name: "Midjourney Standard", price: 30, cat: "Image" },
  { name: "DALL-E (via ChatGPT)", price: 20, cat: "Image" },
  { name: "Adobe Firefly", price: 10, cat: "Image" },
  { name: "Suno Pro (music)", price: 10, cat: "Audio" },
  { name: "ElevenLabs Starter", price: 5, cat: "Audio" },
  { name: "Runway Standard (video)", price: 15, cat: "Video" },
  { name: "Pika Pro (video)", price: 35, cat: "Video" },
  { name: "Notion AI", price: 10, cat: "Productivity" },
  { name: "Superhuman AI", price: 30, cat: "Productivity" },
